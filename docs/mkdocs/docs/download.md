...
[View GitHub Repository](https://github.com/bugfishtm/Bugfish-Dolibarr-Module){.md-button}

## Download the Latest File

To download the latest file from the repository directory, click the link below:

[Download Latest Release](https://github.com/bugfishtm/Bugfish-Dolibarr-Module/archive/refs/heads/main.zip){.md-button}